...
# from alfworld.info import ALFWORLD_CACHE
# from alfworld.info import DETECTORS_CACHE, AGENTS_CACHE
from alfworld.info import ALFRED_PDDL_PATH, ALFRED_TWL2_PATH


JSON_FILES_URL = "https://aka.ms/alfworld/json_2.1.1_json.zip"
PDDL_FILES_URL = "https://aka.ms/alfworld/json_2.1.1_pddl.zip"
TW_PDDL_FILES_URL = "https://aka.ms/alfworld/json_2.1.1_tw-pddl.zip"
MRCNN_URL = "https://aka.ms/alfworld/mrcnn.pth"
CHECKPOINTS_URL = "https://aka.ms/alfworld_pretrained_checkpoints.zip"
SEQ2SEQ_DATA_URL = "https://aka.ms/seq2seq_data.zip"
...
def download(url, dst, force=False):
    ...
    """
    try:
        os.makedirs(dst)  # Create any missing folders.
    except FileExistsError:
        pass

    filename = url.split('/')[-1]
    path = pjoin(dst, filename)
...
def build_argparser():
    ...
    parser.add_argument("--data-dir", default="./data",
                        help="Folder where to download the data. Default: './data'")
